	...
	public class Projectile : Entity
	{
		...
		public void TryToFireEvent()
		{
			try
			{
				...
				SFEventManager.FireEvent(new ProjectileHitEventData { OriginId = EntityId, EventType = SFEventType.ProjectileHit, GameObjectHit = GameObjectHit, HitObjectId = DamageData.TargetId });
