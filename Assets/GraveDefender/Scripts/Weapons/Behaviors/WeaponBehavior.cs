...
public abstract class WeaponBehavior
{
	...
	public static WeaponBehavior CreateWeaponBehavior(IWeapon weapon)
	{
	...
	static WeaponBehavior CreateCompundWEaponBehavior(IWeapon weapon)
	{
	...
	static WeaponBehavior CreateBehavior(IWeapon weapon, WeaponBehaviorType type, WeaponBehaviorUsageType usageType = WeaponBehaviorUsageType.None)
	{
		WeaponBehavior weaponBehavior;
		switch(type)
		{
